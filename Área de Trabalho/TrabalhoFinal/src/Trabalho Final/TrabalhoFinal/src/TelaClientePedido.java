...
public class TelaClientePedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tituloCliente.setText("   Pizzaria LaGu");
        ...
        tituloItemDePedido.setText("Itens da Pizza :");
        ...
        pedidoTipoPizza.setText("Selecione o Tipo:");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(290, 475, Short.MAX_VALUE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(242, 242, 242)
                .addComponent(tituloCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void excluirClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_excluirClienteMouseClicked
        ...
        for(int i = 0; i < listaDePedidos.size(); i++){
            if(listaDePedidos.get(i).getTelefoneCliente().equals(cpf)){
            ...
            for(i = 0; i < listaDePedidos.size(); i++){
                if(listaDePedidos.get(i).getTelefoneCliente().equals(txtPedidoTelefone.getText())){
                    ...
                    for(int j = 0; j < listaDePedidos.get(i).getItens().size(); j++){
                        ...
                        ItemPedido recupera = new ItemPedido(-1L, forma, tipoPizza, tam, valor);
    ...
    private void inserirItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inserirItemMouseClicked
        ...
        if(txtPedidoTelefone.getText().equals("") || txtPedidoL1.getText().equals("") || txtPedidoL2.getText().equals("")){
            ...
            if(achou){
                ...
                if(novo){
                    itensPedido.add(ip);
                    Pedido p = new Pedido(-1L, cpf, itensPedido, precoT);
    ...
    private void alterarItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_alterarItemMouseClicked
        if(linhaClicadaP!=-1){
            ...
            /*cliente.setNome(txtNome.getText());
            cliente.setSobrenome(txtSobrenome.getText());
            cliente.setCpf(txtTelefone.getText());*/
            //Atualiza tabela
    ...
    public void calculaLados(){
        ...
        if(f.equals("Quadrado")){
            ...
            String l2 = Double.toString(cm2);
         
            txtPedidoL1.setText(l1);
            txtPedidoL2.setText(l2);
